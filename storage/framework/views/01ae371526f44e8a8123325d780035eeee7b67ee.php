...
<body>
    <div class="container m-5">
        ...
        <div class="list-group list-group-numbered mt-4">
            ...
            <a href="<?php echo e(url('/DosenSI')); ?>" class="list-group-item list-group-item-action">
                Web Dosen SI
            </a>
        </div>
...
<?php /**PATH C:\MATKUL SEMESTER 4\Pemrograman Framework\fimod3-app\resources\views/routing.blade.php ENDPATH**/ ?>